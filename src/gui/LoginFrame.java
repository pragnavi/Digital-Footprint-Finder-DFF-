...
public class LoginFrame extends JPanel {
    ...
    private void initUI() {
        ...
        loginButton.addActionListener(this::userLoginAction);
        signupButton.addActionListener(this::userSignupAction);
    }
    
    private void userSignupAction(ActionEvent e) {
        SignupFrame signupFrame = new SignupFrame();
        signupFrame.setVisible(true);
    }

    private void userLoginAction(ActionEvent e) {
        String email = userTextField.getText();
        String password = new String(passwordField.getPassword());
